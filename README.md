# QVAC Fake Baby Shower Game Idea Generator

Type a theme and an on-device AI invents a quirky baby shower game idea for it, with a deterministic fun-factor meter.
...
Then open http://localhost:29425
